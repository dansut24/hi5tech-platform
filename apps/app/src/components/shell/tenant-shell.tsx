...
import TenantSidebar, { type TenantShellModule } from "@/components/shell/tenant-sidebar";
...
export default function TenantShell({
  ...
  return (
    <div className="hi5-page min-h-dvh">
      <TenantTopbar tenant={tenant} user={user} modules={modules} activeModule={activeModule} />
      ...
      <div className="mx-auto grid w-full max-w-[1560px] grid-cols-1 gap-5 px-4 pb-8 pt-4 sm:px-6 lg:grid-cols-[280px_1fr] lg:px-8 xl:px-10">
        <aside className="hidden lg:block">
          <TenantSidebar tenant={tenant} modules={modules} activeModule={activeModule} />
        </aside>
