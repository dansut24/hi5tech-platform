        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="hi5-card p-3">
              ...
              <div className="font-semibold mt-1 truncate">{device.groupName}</div>
            </div>
            <div className="hi5-card p-3">
              <div className="text-xs opacity-70">Agent</div>
              <div className="font-semibold mt-1 truncate">{device.agentVersion ?? "—"}</div>
            </div>
            <div className="hi5-card p-3 col-span-2">
          ...
          <div className="hi5-card p-4">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              ...
              <Link className="hi5-btn-ghost text-sm text-center" href={`/control/devices/${encodeURIComponent(device.id)}?tab=terminal`}>
                Terminal
              </Link>
              <Link className="hi5-btn-ghost text-sm text-center" href={`/control/devices/${encodeURIComponent(device.id)}?tab=files`}>
                Files
              </Link>
            ...
            {connectState === "not_installed" && (
              <div className="mt-3 text-xs text-amber-300">
                Viewer not detected.{" "}
                <a
                  href="/downloads/Hi5TechViewerSetup.exe"
                  className="underline"
                  download
                >
