  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className="sticky top-0 z-30 sm:hidden">
        ...
        {/* Adds breathing room under the inset topbar so content doesn't feel glued */}
        <div className="h-3" />
      </div>
      ...
      <div className="sm:flex">
        ...
        {/* Main */}
        <main className="flex-1 px-3 pb-4 sm:px-6 sm:pb-6 lg:px-8 lg:pb-8">
