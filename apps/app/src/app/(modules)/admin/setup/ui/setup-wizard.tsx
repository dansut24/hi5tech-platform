    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button type="button" className="hi5-btn-ghost text-sm" disabled={saving} onClick={() => save()}>
            {saving ? "Saving…" : "Save"}
          </button>
          ...
          {step < 3 ? (
            ...
            <button type="button" className="hi5-btn-primary text-sm" disabled={saving} onClick={finish}>
