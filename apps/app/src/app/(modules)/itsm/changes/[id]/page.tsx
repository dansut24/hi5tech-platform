...
export default function ChangesDetail({ params }: { params: { id: string } }) {
  return (
    <div className="space-y-4">
      <div className="flex items-end justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold">Changes: {params.id}</h1>
          <p className="opacity-80">Detail page — opens as a tab in the ITSM tab bar.</p>
        </div>
        <Link className="underline" href="/itsm/changes">Back to list</Link>
      </div>
